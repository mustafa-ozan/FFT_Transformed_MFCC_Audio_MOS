...
Download: Get the dataset from the Official Zenodo Repository: https://zenodo.org/records/6572573

Organization: Ensure your data folder (named DATA) follows this structure:
